...
class TestHeadHunterAPI(TestCase):
    ...
    @patch("requests.get")
    def test_connect_failure(self, mock_get: Any) -> None:
    ...
    @patch("requests.get")
    def test_get_vacancies_successful(self, mock_get: Any) -> None:
    ...
    @patch("requests.get")
    def test_get_vacancies_no_items_key(self, mock_get: Any) -> None:
