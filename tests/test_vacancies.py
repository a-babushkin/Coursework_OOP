...
class TestVacancy(TestCase):
    ...
    def setUp(self) -> None:
        """Подготовка к тестам."""
        self.vacancy_1 = Vacancy(
            "Developer", "Company A", {"from": 60000, "to": 80000}, "https://example.com", "Разработчик ПО"
        )
        self.vacancy_2 = Vacancy(
            "Tester", "Company B", {"from": 40000, "to": 60000}, "https://example.com", "Тестировщик ПО"
        )
    ...
    def test_salary_setter(self) -> None:
    ...
    def test_company_setter(self) -> None:
    ...
    def test_vacancy_str(self) -> None:
        ...
        expected_string = (
            "Вакансия(id='1', название='Developer', работодатель='Company A', зарплата=70000, "
